Shader "NatureManufacture/Particles/Smoke Lightmap Lit"
{
	Properties
	{
		...
		_Normal_Strength("Normal Strength", Range( -2 , 2)) = 0.5
		...
		[Toggle(USE_NORMAL_MAP_ON)] USE_NORMAL_MAP_ON("Use Normal Map", Float) = 0
	...
	SubShader
	{
		...
		#pragma shader_feature_local USE_NORMAL_MAP_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 worldToTangentDir229 = mul( ase_worldToTangent, ase_worldNormal);
			...
			float4 appendResult222 = (float4(tex2DNode194.r , tex2DNode194.b , ( tex2DNode195.r + tex2DNode195.r ) , 0.0));
			float3 break31_g2 = appendResult222.xyz;
			float2 appendResult35_g2 = (float2(break31_g2.x , break31_g2.y));
			float temp_output_38_0_g2 = _Normal_Strength;
			float lerpResult36_g2 = lerp( 1.0 , break31_g2.z , saturate( temp_output_38_0_g2 ));
			float3 appendResult34_g2 = (float3(( appendResult35_g2 * temp_output_38_0_g2 ) , lerpResult36_g2));
			#ifdef USE_NORMAL_MAP_ON
				float3 staticSwitch225 = appendResult34_g2;
			#else
				float3 staticSwitch225 = worldToTangentDir229;
			#endif
			o.Normal = staticSwitch225;
			...
			float4 temp_cast_2 = (temp_output_190_0).xxxx;
			float3 appendResult197 = (float3(CalculateContrast(_Light_Contrast,temp_cast_2).rgb));
			...
			o.Albedo = ( ( ( lerpResult167 * ( _Light_Intensity * appendResult197 ) ) + appendResult176 ) * appendResult202 );
